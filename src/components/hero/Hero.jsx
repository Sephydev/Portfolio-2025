    ...
    return (
        <div className="lg:m-auto lg:my-20 my-20 pl-4 pr-5 lg:flex lg:flex-row-reverse md:px-15 lg:px-20 lg:justify-between max-w-[1280px]">
            ...
            <div className="lg:max-w-xl lg:flex lg:flex-col justify-center">
                ...
                <a href="https://maps.app.goo.gl/TDmaCWQVWFcxbCBw7" target="_blank" className="mb-2 hover:text-blue-500 transition-all duration-300"><img className="inline mr-2" src={locationIcon} alt="location icon" />Liège, Belgium</a>
